...
namespace Alpari.QA.ProcessRunner.Tests.Hooks
{
    ...
    public class LaunchProcessHooks
    {
        ...
        public void AfterScenario()
        {
            ...
            {
                var process = processRunner.Process;
                try
                {
                ...
                Thread.Sleep(new TimeSpan(0,0,0,1)); // adding a long timeout doesn't help, and you can clearly see the previous cmd windows open, excpt for the first one
                GC.Collect(); //really shouldn't need this!
            }
        }
