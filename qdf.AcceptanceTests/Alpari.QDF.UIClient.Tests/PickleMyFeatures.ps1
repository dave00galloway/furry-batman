...
Pickle-Features -FeatureDirectory $dir\Specs -OutputDirectory $dir\Pickles -SystemUnderTestName Alpari.QDF.UIClient.Tests -DocumentationFormat DHTML -TestResultsFile $dir\bin\Release\TestResult.xml

cd $dir
$specflowReporter = "$SolutionDir\packages\SpecFlow.1.9.0\tools\specflow.exe"
$proj = "Alpari.QDF.UIClient.Tests.csproj"
