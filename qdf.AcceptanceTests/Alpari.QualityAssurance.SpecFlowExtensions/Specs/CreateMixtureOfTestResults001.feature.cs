...
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Pending test one", new string[]
            {
                "TES_78",
                "negative",
                "UAT"
...
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Pending test two", new string[]
            {
                "TES_79",
                "negative",
                "UAT"
