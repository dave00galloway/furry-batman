...
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Setup test data", new string[]
            {
                "mytag"
            });
#line 7
...
#line 8
            testRunner.Given("I have setup the following templated test data as \"defaultUser\":", ((string) (null)),
                table1, "Given ");
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Save test data", ((string[]) (null)));
#line 12
            this.ScenarioSetup(scenarioInfo);
#line hidden
