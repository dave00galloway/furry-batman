...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            var featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"),
                "SpecflowNunitTextReportParser",
                "In order to provide detailed log info in te test results\r\nAs a tester\r\nI want the" +
                " nunit report parser to match up the text output with the xml output", ProgrammingLanguage.CSharp,
                new string[]
                {
                    "Reporting"
                });
...
#line hidden
#line 8
            testRunner.Given("I have an xml test result file", "TestData\\TaggedTestResult.xml",
                ((TechTalk.SpecFlow.Table) (null)), "Given ");
#line 12
            testRunner.And("I have a text test result file \"TestData\\TaggedTestResult.txt\"", ((string) (null)),
...
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Load a text file", ((string[]) (null)));
#line 28
            this.ScenarioSetup(scenarioInfo);
#line 7
            this.FeatureBackground();
#line 29
            testRunner.Then("the text file parser contains some text", ((string) (null)),
...
#line hidden
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Load a text file and check test cases are present",
                ((string[]) (null)));
#line 31
            this.ScenarioSetup(scenarioInfo);
#line 7
            this.FeatureBackground();
#line 32
            testRunner.When("I parse the text test result file as a test-suite collection", ((string) (null)),
                ((TechTalk.SpecFlow.Table) (null)), "When ");
#line 33
            testRunner.Then("the text file parser contains some test cases", ((string) (null)),
                ((TechTalk.SpecFlow.Table) (null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
        ...
        {
            var scenarioInfo =
                new TechTalk.SpecFlow.ScenarioInfo("Load a text file and check test cases with tags are present",
                    ((string[]) (null)));
#line 35
            this.ScenarioSetup(scenarioInfo);
#line 7
...
#line 36
            testRunner.When("I parse the text test result file as a test-suite collection", ((string) (null)),
                ((TechTalk.SpecFlow.Table) (null)), "When ");
#line 37
            testRunner.Then("the text file parser contains some test cases with tags", ((string) (null)),
                ((TechTalk.SpecFlow.Table) (null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
        ...
        public virtual void LoadATextFileAndCheckTestCasesWithAPrimaryTagArePresent()
        {
            var scenarioInfo =
                new TechTalk.SpecFlow.ScenarioInfo(
                    "Load a text file and check test cases with a primary tag are present", ((string[]) (null)));
#line 39
            this.ScenarioSetup(scenarioInfo);
#line 7
            this.FeatureBackground();
#line 40
            testRunner.When("I parse the text test result file as a test-suite collection", ((string) (null)),
                ((TechTalk.SpecFlow.Table) (null)), "When ");
#line 41
            testRunner.Then("the text file parser contains some test cases with a primary tag", ((string) (null)),
                ((TechTalk.SpecFlow.Table) (null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
        ...
        {
            var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Load a text result file and find test cases by tag",
                ((string[]) (null)));
#line 43
            this.ScenarioSetup(scenarioInfo);
#line 7
...
#line 44
            testRunner.When("I parse the xml test result file as a test-suite collection", ((string) (null)),
                ((TechTalk.SpecFlow.Table) (null)), "When ");
#line 45
            testRunner.And("I parse the text test result file as a test-suite collection", ((string) (null)),
                ((TechTalk.SpecFlow.Table) (null)), "And ");
#line hidden
