...
namespace Alpari.QualityAssurance.SpecFlowExtensions.StepBases
{
    ...
    public class StepCentral : MasterStepBase
    {
        ...
        /// <summary>
        /// Use this to specify whether to ignore the namespace rule - this is needed for testing access of TestRunContext without having to fully qualify it's namespace in every StepDef file
        /// </summary>
        ...
        public static CrossStepDefinitionFileOne GetCrossStepDefinitionFileOne
        {
            get
            {
                var CrossStepDefinitionFileOne = (CrossStepDefinitionFileOne)StepCentral.GetStepDefinition(CrossStepDefinitionStepBase.STEP_BASE_ROOT_NAMSPACE + "CrossStepDefinitionFileOne");
        ...
        {
            if (!this.ToString().StartsWith(MasterStepBase.STEP_BASE_ROOT_NAMSPACE))
            {
