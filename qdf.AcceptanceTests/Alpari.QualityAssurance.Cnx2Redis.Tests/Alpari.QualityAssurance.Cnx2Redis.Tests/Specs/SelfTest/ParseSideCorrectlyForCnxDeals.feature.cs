...
namespace Alpari.QualityAssurance.Cnx2Redis.Tests.Specs.SelfTest
{
    ...
    [NUnit.Framework.DescriptionAttribute("Parse Side Correctly")]
    [NUnit.Framework.CategoryAttribute("redisLocalhost")]
    [NUnit.Framework.CategoryAttribute("BookLessDeal:cnx_deals:TestData\\cnx.csv")]
    [NUnit.Framework.CategoryAttribute("MySqlLocalhost")]
    public partial class ParseSideCorrectlyFeature
    {
        
        private static TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "ParseSideCorrectlyForCnxDeals.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-GB"), "Parse Side Correctly", "In order to write reliable test code\r\nAs a QDF Tester\r\nI want to be able to seed " +
                    "a local redis instance with test data", ProgrammingLanguage.CSharp, new string[] {
                        "redisLocalhost",
                        "BookLessDeal:cnx_deals:TestData\\cnx.csv",
                        "MySqlLocalhost"});
