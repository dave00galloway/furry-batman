...
Background: get positions
	...
	#And  I query for open positions after "2014-09-02" on "ars_test_AUKP01"
	When I get all positions for server "DemoClassic" opened from '2014/09/02 00:00:00'	
	And  I query for open positions after "2014-09-02" on "ars_uk_mt4test1"
...
Scenario: Compare open positions
	When I compare the "DemoClassic" positions with the "ars_uk_mt4test1" positions excluding these fields:
		 | ExcludedFields |
		 | Timestamp      |
		 | OpenTime       |
		 | Server         |
