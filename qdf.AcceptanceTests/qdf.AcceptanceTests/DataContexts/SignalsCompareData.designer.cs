...
namespace qdf.AcceptanceTests.DataContexts
{
	...
	public partial class SignalsCompareDataDataContext : DataContext
	{
    ...
    partial void DeleteCompareData(CompareData instance);
		...
		public SignalsCompareDataDataContext(IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SignalsCompareDataDataContext(string connection, MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SignalsCompareDataDataContext(IDbConnection connection, MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public Table<CompareData> CompareDatas
		{
			get
			{
